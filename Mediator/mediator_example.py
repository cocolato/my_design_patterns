...
class SpeakerMgr(DeviceMgr):
    ...
    def enumerate(self):
        ...
        devices.add(DeviceItem(
            "369dd760", "Realtek High Definition Audio", DeviceType.TypeSpeaker))
        devices.add(DeviceItem(
            "59357638", "NVDIA High Definition Audio", DeviceType.TypeSpeaker, True))
        return devices
...
if __name__ == "__main__":
    ...
    for idx in range(0, device_list.get_count()):
        ...
        print(device)
    print(
        f"当前使用的设备:{device_list.get_by_id(device_util.get_cur_device_id(DeviceType.TypeSpeaker)).get_name()}")
